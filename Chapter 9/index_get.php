<fieldset>
    <legend>Menggunakan Methode GET</legend>
    <form name="form1" method="post" action="proses_get.php">
        <table width="288" border="1">
            <tr>
                <td width="95">Nama</td>
                <td width="12">:</td>
                <td width="159"><input type="text" name="nama" id="textfield"></td>
            </tr>
            <tr>
                <td>Alamat</td>
                <td>:</td>
                <td><input type="text" name="alamat" id="textfield2"></td>
            </tr>
            <tr>
                <td>Pekerjaan</td>
                <td>:</td>
                <td><input type="text" name="pekerjaan" id="textfield3"></td>
            </tr>
            <tr>
                <td>Agama</td>
                <td>:</td>
